  ...
  return (
    <section className="login-page">
      <div className="login-visual">
        ...
        <div>
          <p>
            Movie discovery, reviews, shows, and seat booking in one learning
            project.
          </p>
        </div>
      </div>
      ...
      <form className="auth-panel" onSubmit={submit}>
        <div>
          ...
          {isAuthenticated && (
            <p className="notice">
              You are already signed in. Use the dashboard link in the
              navigation bar.
            </p>
          )}
        </div>
        ...
        <div className="quick-logins">
          ...
          <button
            type="button"
            onClick={() => quickLogin("user@cineverse.test")}
          >
            User
          </button>
          ...
          <button
            type="button"
            onClick={() => quickLogin("owner@cineverse.test")}
          >
            Owner
          </button>
          ...
          <button
            type="button"
            onClick={() => quickLogin("admin@cineverse.test")}
          >
            Admin
          </button>
        </div>
